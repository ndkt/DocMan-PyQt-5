...
qtCreatorFile = "/home/ohm/Desktop/Programming/DocMan/v7/ui_files/documentManager.ui"
...
class MyApp(QMainWindow):
    ...
    def createNewEntry(self):
        ...
        newListOfQuantity = [int(qty) for qty in newListOfQuantity]
        sumOfQuantity = str((sum(newListOfQuantity)))
